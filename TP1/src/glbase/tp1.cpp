 ...
 * 'vec4' is part of GLM
 */
CoreTP1::CoreTP1() : Core(), b(vec4(1, 0, 0, 0.5f)), b2(vec4(0, 1, 0, 1)), sphere(vec4(1.0f, 0.5f, 0, 1), 2, 6, 1), f(0)
{
...
void CoreTP1::Render(double dt)
{
	...
	//b2.Render();
	sphere.SetTransform(glm::rotate(glm::mat4(), f, glm::normalize(glm::vec3(1, 0, 0))));
